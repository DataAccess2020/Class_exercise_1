...
From the variable of interest we removed the negative values and did some data preparation for the regression models.
...
In this first regression it's shown how compared to the reference category, which corresponds to the lower lever of education, both the coefficences corresponding to middle and upper education are positive. This means that higher the level of education is, higher will be the level of agreement with the statement saying that homosexual couples are as good as other couples.
